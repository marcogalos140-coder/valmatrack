...
function updateStreakDisplay(streakDays) {
    ...
    streakNumbers = document.querySelectorAll('#streakNumber, #profileStreakNumber');
...
function generateAttendanceRecords() {
    ...
    const records = [
        ...
        { day: 2, weekday: 'Tue', timeIn: '7:00 AM', timeOut: '4:15 PM', totalHours: '9h 12m' },
        { day: 3, weekday: 'Wed', timeIn: '7:06 AM', timeOut: '4:15 PM', totalHours: '9h 09m' },
            ...
            if (dayCounter <= totalDays) {
                ...
                if (dayCounter >= 1 && dayCounter <= 12) {
                    ...
                    if (dayCounter === 3 || dayCounter === 10 || dayCounter === 12) {
                        cell.classList.add('late-box'); // Dec 3, 10, and 12 are late
                        cell.title = 'Late';
                    }
                    else {
...
function generateCalendarRecords() {
    ...
    for (let day = 1; day <= 12; day++) {
        records.push({
            date: `December ${day}:`,
            time: day === 3 || day === 10 || day === 12 ? 'Late' : day === 6 || day === 7 || day === 8 ? 'No Class' : 'On Time'
        });
    }
...
function updateCalendarInfo() {
    ...
    if (monthElement && yearElement) {
        monthElement.textContent = 'December';
