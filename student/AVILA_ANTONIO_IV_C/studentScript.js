...
function initializePage() {
    ...
    const currentStreak = 4; // This should come from your backend/database
        ...
        for (let dayOfWeek = 0; dayOfWeek < 7; dayOfWeek++) {
            ...
            if (dayCounter <= totalDays) {
                ...
                if (dayCounter >= 1 && dayCounter <= 12) {
                    ...
                    if (dayCounter === 10 ) {
                        cell.classList.add('late-box'); // Dec 10 is late
                        cell.title = 'Late';
                    }
                    else {
...
function generateCalendarRecords() {
    ...
    for (let day = 1; day <= 12; day++) {
        records.push({
            date: `December ${day}:`,
            time: day === 10 ? 'Late' : day === 6 || day === 7 || day === 8 || day === 9 ? 'No Class' : 'On Time'
