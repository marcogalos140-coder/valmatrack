...
function generateAttendanceRecords() {
    ...
    const records = [
        ...
        { day: 2, weekday: 'Tue', timeIn: '6:43 AM', timeOut: '4:15 PM', totalHours: '9h 32m' },
        { day: 3, weekday: 'Wed', timeIn: '6:35 AM', timeOut: '4:15 PM', totalHours: '9h 30m' },
        { day: 4, weekday: 'Thu', timeIn: '6:34 AM', timeOut: '4:00 PM', totalHours: '9h 29m' },
        { day: 5, weekday: 'Fri', timeIn: '6:35 AM', timeOut: '4:00 PM', totalHours: '9h 25m' }
    ];
...
function generateCalendarRecords() {
    ...
    for (let day = 1; day <= 12; day++) {
        records.push({
            date: `December ${day}:`,
            time: day === 3 || day === 10 || day === 12 ? 'On Time' : day === 6 || day === 7 ? 'No Class' : 'On Time'
        });
    }
