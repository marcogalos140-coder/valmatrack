...
function studentDashboard() {
  closePopup();
  alert('Redirecting to student part...');
}
...
function verifyCode(code) {
  ...
  if(val == code.toString()) showPopup(`<h2>You have successfully signed up as a parent.</h2><button onclick="parentDashboard()">OK</button>`);
...
function adminSignup() {
  showPopup(`<h2>Admin Signup</h2><button onclick="teacherSignup()">Teacher</button><button onclick="developerSignup()">Developer</button><button onclick="backToRole()">Back</button>`);
}

/* TEACHER */
function teacherSignup() {
  showPopup(`<h2>Teacher Signup</h2><input type="text" id="class-code" placeholder="Enter Class Code"><button onclick="submitTeacher()">Submit</button><button onclick="backToRole()">Back</button>`);
}
...
function developerSignup() {
  showPopup(`<h2>Developer Signup</h2><input type="text" id="dev-pin" maxlength="4" placeholder="Enter 4-digit PIN"><button onclick="submitDev()">Submit</button><button onclick="backToRole()">Back</button>`);
}
